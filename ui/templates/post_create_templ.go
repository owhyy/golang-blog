...
func PostCreate(user *models.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !user.EmailVerified && !user.IsAdmin {
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<form hx-post=\"/posts/create\" hx-target=\"#form-errors\" hx-swap=\"innerHTML\" enctype=\"multipart/form-data\" hx-disabled-elt=\"find button\"><div id=\"form-errors\"></div><label>Title * <input type=\"text\" name=\"title\" aria-describedby=\"title-helper\" required> <small id=\"title-helper\">Required</small></label> <label>Featured Image <input type=\"file\" name=\"featured_image\" accept=\"image/*\"> <small>Optional. Accepted formats: JPG, PNG, GIF, WebP</small></label> <label>Excerpt <textarea name=\"excerpt\" rows=\"3\"></textarea></label> <label>Content * <textarea name=\"content\" rows=\"12\" required></textarea> <small id=\"title-helper\">Required</small></label> <label>Status <select name=\"status\"><option value=\"draft\">Draft</option> <option value=\"published\">Published</option></select></label><div class=\"grid\" style=\"margin-top: 2rem;\"><button type=\"submit\">Create post</button> <a type=\"submit\" href=\"/\" role=\"button\" class=\"secondary\">Cancel</a></div></form>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
